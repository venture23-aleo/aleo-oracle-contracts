...
export function getPcrValues(pcrValues: PcrValuesLeo): PcrValues {
  const result: PcrValues = {
    pcr_0_chunk_1: leo2js.u128(pcrValues.pcr_0_chunk_1),
    pcr_0_chunk_2: leo2js.u128(pcrValues.pcr_0_chunk_2),
    pcr_0_chunk_3: leo2js.u128(pcrValues.pcr_0_chunk_3),
    pcr_1_chunk_1: leo2js.u128(pcrValues.pcr_1_chunk_1),
    pcr_1_chunk_2: leo2js.u128(pcrValues.pcr_1_chunk_2),
    pcr_1_chunk_3: leo2js.u128(pcrValues.pcr_1_chunk_3),
    pcr_2_chunk_1: leo2js.u128(pcrValues.pcr_2_chunk_1),
    pcr_2_chunk_2: leo2js.u128(pcrValues.pcr_2_chunk_2),
    pcr_2_chunk_3: leo2js.u128(pcrValues.pcr_2_chunk_3),
  }
  return result;
}
...
export function getPositionData(positionData: PositionDataLeo): PositionData {
  const result: PositionData = {
    block_index: leo2js.u8(positionData.block_index),
    shift_a: leo2js.u8(positionData.shift_a),
    shift_b: leo2js.u8(positionData.shift_b),
    mask_a: leo2js.u128(positionData.mask_a),
    mask_b: leo2js.u128(positionData.mask_b),
  }
  return result;
}
