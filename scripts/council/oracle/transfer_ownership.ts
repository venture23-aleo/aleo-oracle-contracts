...
import { TransferOwnership } from "../../../artifacts/js/types/veru_oracle_council_imp_v5";
import { getTransferOwnershipLeo } from "../../../artifacts/js/js2leo/veru_oracle_council_imp_v5";
