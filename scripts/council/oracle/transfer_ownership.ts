...
import { TransferOwnership } from "../../../artifacts/js/types/vlink_oracle_council_imp_v1";
import { getTransferOwnershipLeo } from "../../../artifacts/js/js2leo/vlink_oracle_council_imp_v1";
